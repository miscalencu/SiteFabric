...
{
    public class BasicJsonAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        private readonly IJsonUserService _userService;

        public BasicJsonAuthenticationHandler(
